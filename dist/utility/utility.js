...
var FetchApi = function (url, query) {
    return __awaiter(this, void 0, void 0, function () {
        var after, urlModified, response, data, result, _e_1, e;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    urlModified = url + "?after=" + after;
                    return [4 /*yield*/, node_fetch_1.default(urlModified, { method: "GET" })];
                case 2:
                    response = _a.sent();
